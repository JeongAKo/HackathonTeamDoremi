...
class LoginViewController: UIViewController {
    ...
    private let idLogo: UIImageView = {
    ...
    private let passwdLogo: UIImageView = {
    ...
    func createAlert(title: String, message: String) {
        ...
        let idAction = UIAlertAction(title: "ID를 입력하세요", style: .default)
        let pwAction = UIAlertAction(title: "PW를 입력하세요", style: .default)
    ...
    func autoLayout() {
        ...
        NSLayoutConstraint.activate([
            ...
            logoView.leadingAnchor.constraint(equalTo: guaid.leadingAnchor, constant: margin * 8 ),
            logoView.trailingAnchor.constraint(equalTo: guaid.trailingAnchor, constant: -margin * 8),
...
extension LoginViewController: UITextFieldDelegate {
    func textFieldShouldReturn(_ textField: UITextField) -> Bool {
        ...
        let pwText = passwdTextField.text ?? ""
